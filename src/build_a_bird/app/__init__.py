...
def create_app():
    ...
    app.config['MODEL_DEVICE'] = os.getenv('MODEL_DEVICE', 'cpu').lower() # use cpu for text-to-image generated by default
    app.config['MODEL_DTYPE'] = os.getenv('MODEL_DTYPE', 'bfloat16').lower() # use torch.blfoat16 data type by default
    app.config['IMG_SIZE'] = int(os.getenv('IMG_SIZE', 128)) # generate 128x128 images by default
